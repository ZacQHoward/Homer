...
namespace HomerConfig {
    constexpr uint8_t MOTOR_PIN1 = D0;  // Right motor if weapon is facing away from you
    constexpr uint8_t MOTOR_PIN2 = D1;  // Left motor if weapon is facing away from you
